    ...
    <div className="max-w-4xl mx-auto p-8 bg-white">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 ">
        ...
        <div className="lg:col-span-2 flex flex-col  space-y-4 text-gray-800 leading-relaxed">
          <div className="mb-8 mt-16">
            <h1 className="text-xl md:text-2xl tracking-wider font-lyon-semibold">Comunicado Importante</h1>
          </div>
          <div className="space-y-4">
            <p className="font-akkurat-regular">Prezados clientes,</p>
            <p className="font-akkurat-regular text-lg">
              Informamos que o manual As Pirâmides Coloridas de Pfister
              (ISBN 978-65-50721-86-2) apresenta um erro de cálculo na construção das síndromes cromáticas nas tabelas
              do <strong className="font-akkurat-bold">Capítulo 14</strong>, voltadas às normas para crianças e
        ...
        <div className="lg:col-span-1 flex items-end">
          <div className="w-full flex flex-col items-center  pl-0 p-6 rounded-lg">
            <img
              src="/capa.png"
              alt="Capa do manual"
      ...
      <div className="space-y-4 text-gray-800 leading-relaxed mb-10">
        ...
        <a href="/tabelas.pdf" download>
          <Button variant="outline" className="mb-20 mt-4 bg-transparent font-akkurat-regular">
            Acesse aqui
          </Button>
        </a>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3  items-start mt-8">
          <div className="md:col-span-2">
            ...
            <Button variant="outline" className="mt-4 bg-transparent font-akkurat-regular">
          Preencha aqui
        </Button>
          </div>
        
          <div className="lg:col-span-1 flex">
          <div className="w-full flex flex-col items-center  p-6 pt-0 pl-0 rounded-lg">
            <img
              src="/capa.png"
              alt="Capa do manual"
